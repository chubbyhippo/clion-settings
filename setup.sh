...
for config_path in \
	...
	"$HOME"/AppData/Roaming/JetBrains/CLion*; do
	echo "$config_path"
...
# install plugins
curl -k https://raw.githubusercontent.com/chubbyhippo/clion-settings/refs/heads/main/install-plugins.sh | /usr/bin/env sh
